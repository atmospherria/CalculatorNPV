		...
		<table id="table" border="1" style="border-collapse: collapse; margin: auto; width: 100%; height: 262px;"">
			...
			<tr>
				...
				<td class="Cf0" style="text-align: center;">
					...
					<input id="Cf0" type="number" style="width: 99%; height: 100%;"/>
				</td>
				<td class="D0" style="text-align: center;">
					<span id="D0-span" style="visibility: hidden;"></span>
					<input id="D0" type="number" style="width: 99%; height: 100%;"/>
				</td>
			</tr>
			<tr>
				...
				<td class="Cf1" style="text-align: center;">
					...
					<input id="Cf1" type="number" style="width: 99%; height: 100%;"/>
				</td>
				<td class="D1" style="text-align: center;">
					<span id="D1-span" style="visibility: hidden;"></span>
					<input id="D1" type="number" style="width: 99%; height: 100%;"/>
				</td>
			</tr>
			<tr>
				...
				<td class="Cf2" style="text-align: center;">
					...
					<input id="Cf2" type="number" style="width: 99%; height: 100%;"/>
				</td>
				<td class="D2" style="text-align: center;">
					<span id="D2-span" style="visibility: hidden;"></span>
					<input id="D2" type="number" style="width: 99%; height: 100%;"/>
				</td>
			</tr>
			<tr>
				...
				<td class="Cf3" style="text-align: center;">
					...
					<input id="Cf3" type="number" style="width: 99%; height: 100%;"/>
				</td>
				<td class="D3" style="text-align: center;">
					<span id="D3-span" style="visibility: hidden;"></span>
					<input id="D3" type="number" style="width: 99%; height: 100%;"/>
				</td>
			</tr>
			<tr>
...
function export_table_to_csv(html, filename) {
	 ...
	 function calculate()
  {
	...
	for(var j = 0; i < d.length - 1; i++){
        res = (CFs[i]/(1+Math.pow([i],i+1))-CFs[0])+res;
	res = "" + res;
        document.getElementById("res").textContent = res.replace(".", ",");
        break;
    	}
     }
  }
